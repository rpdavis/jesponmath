...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  ...
  [ROLES.TEACHER]:
    'Teacher - Create and manage assessments, add and manage students, view student progress, import from Google Classroom',
...
export const ROLE_HIERARCHY: UserRole[] = [ROLES.ADMIN, ROLES.TEACHER, ROLES.STUDENT]
...
> = {
  [ROLES.ADMIN]: [
    ...
    },
    {
      ...
      icon: '➕',
      permission: PERMISSIONS.CREATE_ASSESSMENTS,
    },
    ...
    { path: '/assessments', label: 'All Assessments', icon: '📝' },
    {
      ...
      icon: '📈',
      permission: PERMISSIONS.VIEW_STUDENT_RESULTS,
    },
    {
    ...
    { path: '/admin/standard-assessment-export', label: 'Export Standard Assessments', icon: '📊' },
    {
      ...
      label: 'Debug Goal Questions',
      icon: '🔍',
      permission: PERMISSIONS.MANAGE_SYSTEM,
    },
    {
      path: '/admin/analyze-goals',
      label: 'Analyze Goals for Templates',
      icon: '📊',
      permission: PERMISSIONS.MANAGE_SYSTEM,
    },
    {
      path: '/admin/templates',
      label: 'Goal Template Management',
      icon: '📋',
      permission: PERMISSIONS.MANAGE_SYSTEM,
    },
    {
  ...
  [ROLES.STUDENT]: [
    { path: '/', label: 'Dashboard', icon: '🏠' },
    {
      ...
      icon: '📝',
      permission: PERMISSIONS.TAKE_ASSESSMENTS,
    },
    {
      path: '/my-results',
      label: 'My Results',
      icon: '📊',
      permission: PERMISSIONS.VIEW_OWN_RESULTS,
    },
  ],
}
